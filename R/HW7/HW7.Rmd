...
Analysis:
From the regression line that the more number of children that the family has, the less difference there is in their age. However, the relation is not very strong.
...
If a family has a children, they have a longer lasting marriage.
...
```{r}
plot(div_month$Freq,type = "o",col = "red", xlab = "Month", ylab = "div11_13", 
   main = "div11_13 by Month")
